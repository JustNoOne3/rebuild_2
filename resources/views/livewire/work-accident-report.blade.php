<x-filament::modal
    ...
    <x-slot name="trigger">
        <x-filament::button class="btn btn-danger"  style="padding: 50px; width: 350px; height: 400px;" color="primary">
                <x-filament::icon icon="heroicon-s-cog-6-tooth" class="mr-2 max-h-36" />
                <div class="grid grid-rows-4 grid-cols-1 ">
                    <div>EMPLOYER'S WORK ACCIDENT</div>
                    <div>/ ILLNESS FORM</div>
                    <div></div>
                    <div></div>
                </div>
        </x-filament::button>
