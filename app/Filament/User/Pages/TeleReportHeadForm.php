...
class TeleReportHeadForm extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.user.pages.tele-report-head-form';
                                ...
                                ->schema([
                                    ...
                                    Forms\Components\Actions::make([
                                        Forms\Components\Actions\Action::make('myModalActionSADA')
                                            ->label('Create a Report for Branches/Satellite Offices')
